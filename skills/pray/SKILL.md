---
name: pray
description: 急功近利地工程化祈祷。用户给出愿望 + 可选身份锚定信息，生成按规范、跨派别合成的祈祷词 md。触发词：祈祷/发愿/求愿/转经/念经/pray/"保佑..."/"愿..."
---
...
工程化、急功近利、有针对性的祈祷词生成器。**不质疑玄学本身**——只是把已有的高效祈祷范式（藏传转经筒、天主教 Novena、伊斯兰 Tasbih、道教科仪、chaos magic sigil 等）统一编码为可调度的 skill 库。
